	...
	<head>
		...
		<style>
			...
			.navbar-default:hover{
				box-shadow: 0 6px 10px rgba(255, 26, 26, 0.6);
			}
			.active{
    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
				...
				<!-- Menu and Search bar -->
					<ul class="nav navbar-nav">
						...
						<li ><a id = "active" title="Πληροφορίες για τους κωδικούς που έχουμε συλλέξει" href = "CodesGR.php" class="btn material_btn red active"><i class="fa fa-code-fork" aria-hidden="true"></i> Κωδικοί</a></li>
